...
export const translations = {
  ...
  // ARENA PROMO (restaurant near Arena)
  arena_promo: {
    label: { it: "Geheimtipp Verona", en: "Hidden Gem Verona", es: "Joya Oculta Verona", de: "Geheimtipp Verona", ru: "Секретное место Верона", ro: "Bijuterie Ascunsă Verona", zh: "维罗纳隐藏宝地", ja: "ヴェローナの穴場" },
    title: { it: "Ristorante vicino all'Arena di Verona", en: "Restaurant near the Arena di Verona", es: "Restaurante cerca de la Arena de Verona", de: "Restaurant in der Nähe der Arena di Verona", ru: "Ресторан рядом с Ареной ди Верона", ro: "Restaurant lângă Arena di Verona", zh: "维罗纳竞技场附近餐厅", ja: "アレーナ・ディ・ヴェローナ近くのレストラン" },
    p1: { it: "La Vecia Mescola è il ristorante ideale per una serata a Verona — a soli 2 minuti a piedi dall'Arena. Cucina veneta autentica: pasta fresca fatta in casa, risotto all'Amarone e il famoso Chateaubriand. Un vero gioiello nascosto.", en: "La Vecia Mescola is the ideal restaurant for an evening in Verona — just a 2-minute walk from the Arena. Authentic Venetian cuisine: fresh homemade pasta, Amarone risotto, and the famous Chateaubriand. A true hidden gem.", es: "La Vecia Mescola es el restaurante ideal para una velada en Verona — a solo 2 minutos a pie de la Arena. Cocina véneta auténtica: pasta fresca casera, risotto al Amarone y el famoso Chateaubriand. Una joya escondida.", de: "La Vecia Mescola ist das ideale Restaurant für einen Abend in Verona — nur 2 Gehminuten von der Arena entfernt. Authentische venezianische Küche: hausgemachte Pasta, Risotto all'Amarone und das berühmte Chateaubriand. Der perfekte Geheimtipp für Verona.", ru: "La Vecia Mescola — идеальный ресторан для вечера в Вероне, всего в 2 минутах ходьбы от Арены. Аутентичная венетская кухня: свежая домашняя паста, ризотто с Амароне и знаменитый Шатобриан. Настоящая скрытая жемчужина.", ro: "La Vecia Mescola este restaurantul ideal pentru o seară în Verona — la doar 2 minute de mers pe jos de Arenă. Bucătărie venețiană autentică: paste proaspete de casă, risotto cu Amarone și celebrul Chateaubriand. O adevărată bijuterie ascunsă.", zh: "La Vecia Mescola 是您在维罗纳度过美好夜晚的理想餐厅——距竞技场仅2分钟步行路程。正宗威尼托美食：手工新鲜意面、阿玛罗内烩饭和著名的夏多布里昂牛排。一个真正的隐藏瑰宝。", ja: "La Vecia Mescolaは、ヴェローナでの夜に最適なレストランです。アレーナから徒歩わずか2分。本格ヴェネト料理：手打ち生パスタ、アマローネのリゾット、そして有名なシャトーブリアン。まさに隠れた名店。" },
    h3: { it: "Cena prima dello spettacolo o del concerto", en: "Dinner before the show or concert", es: "Cena antes del espectáculo o concierto", de: "Abendessen vor der Oper oder dem Konzert", ru: "Ужин перед спектаклем или концертом", ro: "Cină înainte de spectacol sau concert", zh: "演出或音乐会前的晚餐", ja: "公演やコンサート前のディナー" },
    p2: { it: "Stai pianificando una cena prima dello spettacolo all'Arena di Verona? Ti consigliamo una prenotazione 2–3 ore prima dell'inizio. La nostra cucina serve fino alle 22:30 (venerdì e sabato fino alle 23:00).", en: "Planning dinner before your show at the Arena di Verona? We recommend booking 2–3 hours before the start. Our kitchen serves until 10:30 PM (Fridays and Saturdays until 11:00 PM).", es: "¿Planeas cenar antes del espectáculo en la Arena de Verona? Recomendamos reservar 2–3 horas antes del inicio. Nuestra cocina sirve hasta las 22:30 (viernes y sábados hasta las 23:00).", de: "Planen Sie ein Abendessen vor Ihrer Vorstellung in der Arena di Verona? Wir empfehlen eine Reservierung 2–3 Stunden vor Beginn. Unsere Küche serviert bis 22:30 Uhr (freitags und samstags bis 23:00 Uhr).", ru: "Планируете ужин перед спектаклем в Арене ди Верона? Рекомендуем бронировать за 2–3 часа до начала. Наша кухня работает до 22:30 (пятница и суббота до 23:00).", ro: "Planificați o cină înainte de spectacolul de la Arena di Verona? Recomandăm o rezervare cu 2–3 ore înainte de start. Bucătăria noastră servește până la 22:30 (vineri și sâmbătă până la 23:00).", zh: "计划在维罗纳竞技场演出前用餐？我们建议提前2–3小时预订。我们的厨房服务至22:30（周五和周六至23:00）。", ja: "アレーナ・ディ・ヴェローナの公演前にディナーをご計画ですか？開演2〜3時間前のご予約をおすすめします。キッチンは22:30まで（金・土は23:00まで）営業しています。" },
    whatsapp_cta: { it: "Prenota via WhatsApp", en: "Book via WhatsApp", es: "Reservar por WhatsApp", de: "Tisch reservieren via WhatsApp", ru: "Забронировать через WhatsApp", ro: "Rezervă prin WhatsApp", zh: "通过WhatsApp预订", ja: "WhatsAppで予約" },
  },
