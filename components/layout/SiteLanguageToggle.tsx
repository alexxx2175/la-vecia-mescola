...
export function SiteLanguageToggle() {
  ...
  return (
    <div ref={ref} className="fixed bottom-6 left-6 z-[100]">
        ...
        <AnimatePresence>
          {open && (
            <motion.ul
              ...
              className="absolute bottom-full left-0 mb-2 w-48 overflow-hidden rounded-lg border border-[#B8962E]/30 bg-[#F5F0E8] shadow-lg z-[100]"
            >
              {LANGUAGES.map((l) => (
